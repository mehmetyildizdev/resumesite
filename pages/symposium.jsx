...
function symposium() {
  return (
    <div className="w-full">
      <Heading
        title="Mehmet YILDIZ | Fuat Sezgin Symposium"
        description="Full-stack web development and web master services for International Prof. Dr. Fuat Sezgin Symposium on the History of Science in Islam"
      />
